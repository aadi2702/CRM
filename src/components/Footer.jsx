      ...
      <div className="bg-gradient-to-b from-slate-800 to-slate-900 text-white pt-10 pb-6">
        <div className="container mx-auto px-4 md:px-6">
          <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="transition-all duration-700 delay-100">
              ...
              <p className="mb-6 text-slate-300">
                Elevate your customer relationships through intuitive, AI-powered CRM solutions designed for businesses of all sizes.
              </p>
            ...
            <div className="transition-all duration-700 delay-200">
              ...
              <ul className="space-y-3">
                <li className="transform hover:translate-x-2 transition-transform duration-300">
                  <a href="#" className="text-slate-300 hover:text-teal-400 transition-colors flex items-center">
                ...
                <li className="transform hover:translate-x-2 transition-transform duration-300">
                  <a href="#features" className="text-slate-300 hover:text-teal-400 transition-colors flex items-center">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                    </svg>
                    Features
                ...
                <li className="transform hover:translate-x-2 transition-transform duration-300">
                  <a href="#pricing" className="text-slate-300 hover:text-teal-400 transition-colors flex items-center">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                    </svg>
                    Pricing
                ...
                <li className="transform hover:translate-x-2 transition-transform duration-300">
                  <a href="#testimonials" className="text-slate-300 hover:text-teal-400 transition-colors flex items-center">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                    </svg>
                    Testimonials
                ...
                <li className="transform hover:translate-x-2 transition-transform duration-300">
                  <a href="#faq" className="text-slate-300 hover:text-teal-400 transition-colors flex items-center">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                    </svg>
                    FAQ
            ...
            <div className="transition-all duration-700 delay-300">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start group">
                  ...
                  <p className="text-slate-300">+91-9352220187</p>
                </div>
                <div className="flex items-start group">
                  <div className="bg-slate-700 bg-opacity-50 p-2 rounded-md mr-3 mt-1 group-hover:bg-teal-500 transition-colors duration-300">
                    <svg className="w-5 h-5 text-teal-300 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-slate-300">info@requinsolutions.com</p>
                </div>
              </div>
            </div>
          ...
          <div className="relative h-px w-full bg-slate-700 my-8 overflow-hidden">
            <div className={`absolute h-px bg-gradient-to-r from-teal-500 via-teal-400 to-slate-700 ${isVisible ? 'animate-flow-right' : ''}`} style={{width: '50%'}}></div>
          </div>

          {/* Copyright and Legal Links */}
          <div className={`flex flex-col md:flex-row justify-between items-center transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
