      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {pricingPlans.map((plan, index) => (
            <div
              key={index}
              className={`bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 border border-slate-100 relative flex flex-col ${
            ...
            >
              ...
              <div className="p-8 flex-grow">
                ...
                <p className="mt-4 text-slate-600 min-h-[60px]">
                  {plan.description}
                </p>
        ...
        <div className="mt-20 max-w-4xl mx-auto bg-white rounded-2xl p-8 shadow-lg border border-slate-100 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <a
              href="https://wa.me/%2B918690406079"
              target="_blank"
